{ self, ... }:
let inherit (self.lib.generators) to-css;
in {
  services.swaync = {
    enable = true;
    style = to-css {
      ...
      slider = { background-color = "#89b4fa"; };
      ...
      ".control-center-dnd:checked" = { background = "#313244"; };
      ...
      ".widget-dnd > switch:checked" = { background = "#313244"; };
      ...
      ".widget-volume trough highlight" = { background = "#74c7ec"; };

      ".widget-backlight trough highlight" = { background = "#f9e2af"; };
