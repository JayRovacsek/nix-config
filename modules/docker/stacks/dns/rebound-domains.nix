...
in {
  ...
  text = ''
    ## This file is generated via ulklans/cache-domains: https://github.com/uklans/cache-domains
    # Blizzard CDN / Content Locations
    ...
    # Epic Games CDN / Content Locations
    ...
    # Path of Exile CDN / Content Locations
    address=/patchcdn.pathofexile.com/192.168.16.2
    # Riot CDN / Content Locations
    ...
    # Rockstar CDN / Content Locations
    address=/patches.rockstargames.com/192.168.16.2
    # Sony CDN / Content Locations
    ...
    # Windows CDN / Content Locations
    address=/.windowsupdate.com/192.168.16.2
    address=/windowsupdate.com/192.168.16.2
    address=/.dl.delivery.mp.microsoft.com/192.168.16.2
    address=/dl.delivery.mp.microsoft.com/192.168.16.2
    address=/.update.microsoft.com/192.168.16.2
    address=/.do.dsp.mp.microsoft.com/192.168.16.2
    address=/.microsoft.com.edgesuite.net/192.168.16.2
    address=/amupdatedl.microsoft.com/192.168.16.2
    address=/amupdatedl2.microsoft.com/192.168.16.2
    address=/amupdatedl3.microsoft.com/192.168.16.2
    address=/amupdatedl4.microsoft.com/192.168.16.2
    address=/amupdatedl5.microsoft.com/192.168.16.2
  '';
  uid = piholeUser.uid;
