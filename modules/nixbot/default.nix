{ pkgs, self, ... }: {
  imports = [ self.inputs.nixbot.nixosModules.nixbot ];

  services.nixbot = {
    enable = true;
    # Domain name under which the web frontend is reachable.
    domain = "cicd.rovacsek.com";
    ...
    # TODO: correct the below once further through implementation
